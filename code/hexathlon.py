...
file_name = "../hexathlon.json"  # Ensure this file is in the same directory as your script
...
output_file = os.path.join(output_dir, "hexathlon.txt")
with open("generatedText/hexathlon.txt", "w") as file:
    file.write(generated_purpose)

print("Output saved to hexathlon.txt")

reference = [
    [
        "the", "purpose", "is", "to", "develop", "models", "that", "can", 
        "construct", "accurate", "3d", "maps", "from", "diverse", "images", 
        "taken", "under", "various", "conditions", "advancing", "computer", 
        "vision", "techniques", "in", "image", "matching", "and", "3d", 
        "reconstruction"
    ]
]
