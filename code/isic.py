...
file_name = "../isic.json"  # Ensure this file is in the same directory as your script
...
output_file = os.path.join(output_dir, "isic.txt")
with open("generatedText/isic.txt", "w") as file:
    file.write(generated_purpose)

print("Output saved to isic.txt")

reference = [
    [
        "the", "purpose", "is", "to", "develop", "ai", "algorithms", "that", 
        "can", "detect", "skin", "cancer", "from", "lower-quality", "images", 
        "to", "improve", "early", "diagnosis", "especially", "in", "areas", 
        "with", "limited", "access", "to", "specialized", "dermatologic", "care"
    ]
]
